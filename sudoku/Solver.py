...
def displayGridcmdBlankSpace(sudoku):
...
def positionalListGenerator(sudokuGrid):
...
def main():
    ...
    print("ENTERED SUDOKU GRID: 0 MEANS NO ELEMENT")  
    ...
    displayGridcmd(solveSudokuConcise(sudokuGrid))
...
def solveSudokuConcise(sudokuGridFunctionParam):
    #singleElementCheck
    listFound = False
    for row in range(0,9):
        for col in range(0,9):
            if type(sudokuGridFunctionParam[row][col]) == list:
                ...
                break
    if listFound == False:
        return sudokuGridFunctionParam
        ...
        for col in range(0,9):
            ...
            if type(sudokuGridFunctionParam[row][col]) == list:
                ...
                for element in elementList:
                    ...
                    returnGrid = solveSudokuConcise(sudokuGridFunctionParam)
                    if(returnGrid != False):
                        return returnGrid
                    else:
                        sudokuGridFunctionParam[row][col] = list(backup)
                        continue
                        #we move on to the next element in the list of the current block as a sudoku solution was not possible with the picked element
                return False
        ...
        for col in range(0,9):
            ...
            if type(sudokuGridFunctionParam[row][col]) == list:
                ...
                for element in elementList:
                    ...
                    #recursion happens here
                    returnGrid = solveSudoku(sudokuGridFunctionParam)
                    if(returnGrid != False):
                        # displayGridcmd(sudokuGridFunctionParam)
                        # input()
                        return returnGrid
